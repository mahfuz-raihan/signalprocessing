# -*- coding: utf-8 -*-
"""
Created on Wed Mar 23 17:47:36 2022
...
def fourth_signal():
    ...
    axs[1, 1].set_ylabel("Asin(wt)", fontsize=7)
    axs[1, 1].plot(t4, y4, color='m')
    # axs[1, 1].ylim(-2, 2)
    axs[1, 1].grid()

fig.suptitle("Continuous time signal generator") # title of the whole figure
